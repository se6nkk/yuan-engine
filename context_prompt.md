...
> ⚠️ **本文档已过时（2026-08-14 标注）**：以下内容描述的是 **v24 旧管线**（GLM-4-Plus、五层框架、~782KB、`window.__TAURI__.core.invoke`），与当前实现（v25+：DeepSeek 联网搜索、12 模块认知框架、单文件 1.2MB）不符。
> **当前事实源以根目录 `README.md` 与 `CHANGELOG.md` 为准。** 本文档保留供历史参考。
